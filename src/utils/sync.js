...
/* ============================================================
    Warehouse Brain — utils/sync (локальное хранение в IndexedDB)
   
    Пакетная отправка сканов в локальную очередь IndexedDB.
...
/** Синхронизация базы brain items с локальным хранилищем */
export async function syncBrainItems(items) {
  try {
    ...
    // Ошибка импорта здесь гасится: стор сам выставит syncError
  }
}

/** Загрузка базы brain items из локального хранилища */
...
/** Удаление всей базы brain items из локального хранилища */
...
/** Загрузка separate items из локального хранилища */
...
/** Синхронизация отдельного товара с локальным хранилищем */
